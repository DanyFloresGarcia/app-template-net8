...
{
  "Information": [
    "Generated by Amazon.Lambda.Tools"
  ],
  "profile": "default",
  "region": "us-west-2",
  ...
  "function-handler": "CreateCustomerLambda::CreateCustomerLambda.Function::FunctionHandler",
  "function-name": "CreateCustomerLambda",
  "function-description": "Lambda de creación de Customers",
  "function-timeout": 30,
...
## 11. Agregar referencia en la lambda
```
dotnet add package Amazon.Lambda.RuntimeSupport
```

## 12. Probar Test Lambda
cd src/Lambdas/CreateInvitadoLambda
```
  dotnet build
...
## 13. Agregar variables de entorno
setx COGNITO_CLIENT_ID "tu-app-client-id-de-cognito"

## 13. Verificar variables de entorno
echo $env:COGNITO_CLIENT_ID
